...
try {
    ...
    $r = $cnx->prepare("select l.nom_lang,l.id , count(*) as nbl from langues l join inscris i on l.id=i.id group by l.nom_lang,l.id
    ");
                        ...
                        <tbody>
                            <?php foreach ($langue as $l) { ?>
                                <tr>
                                    ...
                                    <td scope="row"><?= $l['nbl'] ?></td>

                                    <td><a class="btn btn-sm btn-danger" href="delete.php?id=<?= $l['id'] ?>" onclick="return confirm('voulez vous supprimer ?')"><i class="fa fa-trash"></a></td>
                                </tr>
                            <?php } ?>
